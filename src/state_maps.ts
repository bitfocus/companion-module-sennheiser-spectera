...
export const MobileDeviceStateMap: StateMap<SEKDevice & SKMDevice> = {
	...
	frequencyRange: { variable: 'frequency_range', valueFn: (v: unknown): any => v },
	rfChannelId: { variable: 'rf_channel_id', valueFn: (v: unknown): any => v },
	identify: { variable: 'identify', valueFn: (v: unknown): any => v },
	reverseIdentify: { variable: 'reverse_identify', valueFn: (v: unknown): any => v },
	serial: { variable: 'serial', valueFn: (v: unknown): any => v },
	connected: { variable: 'connected', valueFn: (v: unknown): any => v },
	sleep: { variable: 'sleep', valueFn: (v: unknown): any => v },
	state: { variable: 'state', valueFn: (v: unknown): any => v },
	batteryFillLevel: { variable: 'battery_level', valueFn: (v: unknown): any => (v === -1 ? 'OFF' : v) },
	batteryRuntime: { variable: 'battery_runtime', valueFn: (v: unknown): any => (v === -1 ? 'OFF' : v) },
	batteryLow: { variable: 'battery_low', valueFn: (v: unknown): any => v },
	version: { variable: 'version', valueFn: (v: unknown): any => v },
	versionMismatch: { variable: 'version_mismatch', valueFn: (v: unknown): any => v },
	fccId: { variable: 'fcc_id', valueFn: (v: unknown): any => v },
	ledBrightness: { variable: 'led_brightness', valueFn: (v: unknown): any => v },
	...
	micAudiolinkId: { variable: 'mic_audiolink_id', valueFn: (v: unknown): any => v },
	micAudiolinkActive: { variable: 'mic_audiolink_active', valueFn: (v: unknown): any => v },
	micTestToneEnabled: { variable: 'mic_test_tone_enabled', valueFn: (v: unknown): any => v },
	micTestToneLevel: { variable: 'mic_test_tone_level', valueFn: (v: unknown): any => v },
	commandState: { variable: 'command_state', valueFn: (v: unknown): any => v },
	micLqi: { variable: 'mic_lqi', valueFn: (v: unknown): any => v },
	interference: { variable: 'interference', valueFn: (v: unknown): any => (v as any)?.severity },
	dominantAntenna: { variable: 'dominant_antenna', valueFn: (v: unknown): any => v },
	rssi: { variable: 'rssi', valueFn: (v: unknown): any => v },
	// SEK specific
	headphoneVolume: { variable: 'headphone_volume', valueFn: (v: unknown): any => v },
	headphoneBalance: { variable: 'headphone_balance', valueFn: (v: unknown): any => v },
	micPreampGain: { variable: 'mic_preamp_gain', valueFn: (v: unknown): any => v },
	micLowCutHz: { variable: 'mic_lowcut_hz', valueFn: (v: unknown): any => v },
	...
	headphonePlugState: { variable: 'headphone_plug_state', valueFn: (v: unknown): any => v },
	headphoneVolumeMax: { variable: 'headphone_volume_max', valueFn: (v: unknown): any => v },
	headphoneVolumeMin: { variable: 'headphone_volume_min', valueFn: (v: unknown): any => v },
	micLineSelection: { variable: 'mic_line_selection', valueFn: (v: unknown): any => v },
	micLineSelectionAutoValue: { variable: 'mic_line_selection_auto_value', valueFn: (v: unknown): any => v },
	cableEmulation: { variable: 'cable_emulation', valueFn: (v: unknown): any => v },
